...
public class ServerListener : MonoBehaviour {
    ...
    void startServer() {
        SocketThread = new System.Threading.Thread(startLocalHost);
    ...
    void recievedGMD(String serverMessage, String GMD_Type) {
        ...
        if (revObj != null) {
            ...
            } else if (GMD_Type == "SCALE") { // Received scale data
                String[] xyz = splitsb[1].Split(',');
